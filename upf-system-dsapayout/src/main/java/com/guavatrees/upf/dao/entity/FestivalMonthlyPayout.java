...
@Table(name = "festivalmonthlypayout")
public class FestivalMonthlyPayout implements Serializable{
	@Id
	...
	private long minfilesdisbursed;
	...
	public long getMinfilesdisbursed() {
		return minfilesdisbursed;
	}

	public void setMinfilesdisbursed(long minfilesdisbursed) {
