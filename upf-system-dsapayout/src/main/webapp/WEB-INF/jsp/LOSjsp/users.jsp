           	...
           	<tr id="btnAddUsrDisId">
				...
				<div class="row" id="dsaCodeRowId" style="background-color: #fff; padding-top:20px;padding-bottom:10px;">
		            ...
		            <span id="agrmntPthHidId" class="a-dis"></span>
		             ...
		             <span id="panUptDtHidId" class="a-dis"></span>
		            <span id="aadhaarUptDtHidId" class="a-dis"></span>
		            <span id="shpActUptDtHidId" class="a-dis"></span>
		            <span id="canChckUptDtHidId" class="a-dis"></span>
		            <span id="agrmntUptDtHidId" class="a-dis"></span>
				...
				<div class="row" style="background-color: #fff; padding-bottom:15px;" align="center">
					...
					<div class="col-md-3">
					<input type="file" id="uploadPanDsaId" name="Pan" class="filestyle fileCls" accept="image/jpeg, image/png, application/pdf, image/*"  data-buttonBefore="true">
					</div>
					<div class="col-md-1">  
					...
					<div class="col-md-3">
					<input type="file" id="uploadAdhDsaId" name="Aadhaar" class="filestyle fileCls" accept="image/jpeg, image/png, application/pdf, image/*"  data-buttonBefore="true">
					</div>
					<div class="col-md-1">
				...
				<div class="row" style="background-color: #fff; padding-bottom:15px;" align="center">
					...
					<div class="col-md-3">
					<input type="file" id="uploadShopActId" name="ShopAct" class="filestyle fileCls" accept="image/jpeg, image/png, application/pdf, image/*"  data-buttonBefore="true">
					</div>
					<div class="col-md-1">  
					...
					<div class="col-md-3">
					<input type="file" id="uploadCnclChckId" name="CancelledCheque" class="filestyle fileCls" accept="image/jpeg, image/png, application/pdf, image/*"  data-buttonBefore="true">
					</div>
					<div class="col-md-1">
				...
				<div class="row" style="background-color: #fff; padding-bottom:15px;" align="center">
					...
					<div class="col-md-3">
					<input type="file" id="uploadAgrmntId" name="Agreement" class="filestyle fileCls" accept="image/jpeg, image/png, application/pdf, image/*"  data-buttonBefore="true">
					</div>
					<div class="col-md-1">  
      ...
      <div class="row" style="background-color: #fff;">
      	<div class="col-md-6">
      		<table class="table">
      			...
      			<td><input type="email" class="form-control" id="smEmailId" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" required="required"></td>
      			</tr>
      			<tr id="proTypeTrId">
				...
				<tr  id="appLnAmntSmTrId">
      			...
      			<tr class="coaTrCls">
				<td>IMEI No.1<span class="a-color">*</span> : </td>
				<td><input type="text" maxlength="15" onkeyup="$_imeiCheck(event,this)" class="form-control" id="iMEINO1_Id" required="required" pattern="[0-9]{15}"></td>
				</tr>
				<!-- <tr class="coaTrCls">
				<td>IMEI No.2 (optional)<span class="a-color"></span> : </td>
				<td><input type="text" maxlength="15" onkeyup="$_imeiCheck(event,this)" class="form-control" id="iMEINO2_Id" pattern="[0-9]{15}"></td>
				</tr> -->
      		</table>
      	</div>
      	<div class="col-md-6">
      		<table class="table">
      			...
      			<td><input type="text" maxlength="10" class="form-control" id="smContctNumId" pattern="\d{10}" required="required"></td>
      			</tr>
      			<tr id="citySmTrId">
				...
				<tr class="coaTrCls">
				<td>Status<span class="a-color">*</span> : </td>
				<td>
				<select class="form-control" id="statusSlctSmId" required="required">
