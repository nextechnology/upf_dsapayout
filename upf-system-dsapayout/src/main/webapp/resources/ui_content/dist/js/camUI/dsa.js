...
var  API_APPSTAT_POST = '/upf-system-dsapayout/dsapayout/dsa/getlistdsa'
	...
	,API_DSA_GET = '/upf-system-dsapayout/dsapayout/dsa/getDsabyuserid?userid='
	,API_DSA_POST = '/upf-system-dsapayout/dsapayout/dsa/addDsaInfo'
	,API_DSACODE_POST = '/upf-system-dsapayout/dsapayout/dsa/getDsabyuserid?userid='
	...
	,API_STATECODE_GET = '/upf-system-dsapayout/dsapayout/dsa/getstatecode?state='
	,API_INVOICE_GET = '/upf-system-dsapayout/dsapayout/dsa/createinvoicepdf'
	//API_INVOICE_GET = '/upf-system-dsapayout/dsapayout/dsa/generateinvoice?dsacode='
	,API_INVOICEQRTR_GET = '/upf-system-dsapayout/dsapayout/dsa/quarterlyinvoice?dsacode='
    ,API_BANKNAME_GET = '/upf-system-dsapayout/dsapayout/dsa/getlistbank'
    ...
    ,API_COST_POST = '/upf-system-dsapayout/dsapayout/dsa/addadmindsa'
    ,API_EMAIL_SEND = '/upf-system-dsapayout/dsapayout/dsa/sendemailnsm'
    ,API_SMS_SEND = '/upf-system-dsapayout/dsapayout/dsa/sendSms'
    ,API_INVOICE_DEL = '/upf-system-dsapayout/dsapayout/dsa/deleteinvoice'
    ,API_EMAIL_NSM = '/upf-system-dsapayout/dsapayout/dsa/sendEmailNsmOnDisagree'
    ,API_INVOICE_CHECK = '/upf-system-dsapayout/dsapayout/dsa/checkInvoiceNo'
    ,API_STATEBYCODE_GET = '/upf-system-dsapayout/dsapayout/dsa/getStateData?statecode='
    ;
var compData = {};
var fileName;
...
/*					tblData += 
				...
				$('.filterDSA').val('').removeAttr('disabled');
				requestData(API_ALLLOGINDETAIL_GET, "GET",{}).done(function(reply) {
					$(reply.accessList).each(function(k,v){
					if( v.DSA_TAB == "READ ONLY" ||  v.DSA_TAB == "READONLY" || v.DSA_TAB == "READ" ){
